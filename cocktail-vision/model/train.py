...
주류 이미지 데이터셋 기준 (Kaggle Alcohol Bottle Dataset)

데이터 폴더 구조:
  dataset/
    train/
      Vodka/   img1.jpg  img2.jpg ...
      Whiskey/ ...
    val/
      ...
"""
...
DATA_DIR   = "dataset"
SAVE_PATH  = "model/efficientnet_spirit.pth"
...
def train():
    ...
    print(f"클래스 수: {len(train_ds.classes)} → {train_ds.classes}")
